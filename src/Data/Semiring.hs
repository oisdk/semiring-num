...
{-# RULES
"simd/plus/int32"  (<+>) = addInt32s
"simd/plus/int64"  (<+>) = addInt64s
"simd/plus/int8"   (<+>) = addInt8s
"simd/plus/double" (<+>) = addDoubles
"simd/plus/float"  (<+>) = addFloats
"simd/conv/int32"  (<.>) = convInt32s
"simd/conv/int64"  (<.>) = convInt64s
"simd/conv/int8"   (<.>) = convInt8s
"simd/conv/double" (<.>) = convDoubles
"simd/conv/float"  (<.>) = convFloats
#-}
